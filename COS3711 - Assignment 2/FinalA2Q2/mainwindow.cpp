...
void MainWindow::ui() {
    ...
    queryLayout->addWidget(new QLabel("Query the Name:"));
    ...
    affiliationLayout->addWidget(new QLabel("Query the Affiliation:"));
    ...
    buttonLayout->addWidget(saveButton); // Added save button to layout
